...
public class Characters {
    public static void main(String[] args) {
        /*
        Java Character data types store a single character,
        they must also be surrounded by 'single quotes'.
        Unlike Strings that use "double quotes".
         */
        char a = 'A';
        char b = 65;
        ...
        /*
        As you can see, both the outputs are capital A, but char b is a number.
        This number refers to the ASKII table which is a table of values
        that can be used as declarations.
        ...
        char weirdChar = 178;
        int weirdChar2 = 1;
        System.out.println(weirdChar2 + " " + weirdChar);
    }
}
/*
Here is the full list of the ASKII table :
( Number (as value) - Symbol (outcome) - discription.
